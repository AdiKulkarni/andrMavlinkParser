        ...
        */
        public byte pPayload[] = new byte[251];
        ...
        */
    	...
    	return "MAVLINK_MSG_ID_FILE_TRANSFER_PROTOCOL -"+" target_network:"+target_network+" target_system:"+target_system+" target_component:"+target_component+" payload:"+pPayload+"";
        }
        }
