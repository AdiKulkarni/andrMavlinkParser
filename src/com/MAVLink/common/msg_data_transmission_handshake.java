        ...
        */
		...
		packet.msgid = MAVLINK_MSG_ID_DATA_TRANSMISSION_HANDSHAKE;
        		...
        		packet.payload.putByte(pPayload);
        ...
        */
    	...
    	return "MAVLINK_MSG_ID_DATA_TRANSMISSION_HANDSHAKE -"+" size:"+size+" width:"+width+" height:"+height+" packets:"+packets+" type:"+type+" payload:"+pPayload+" jpg_quality:"+jpg_quality+"";
        }
        }
